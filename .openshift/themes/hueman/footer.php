	...
	<footer id="footer">
		...
		<?php if ( has_nav_menu( 'footer' ) ): ?>
			<nav class="nav-container group" id="nav-footer">
				...
				<div class="nav-text"><!-- put your marco menu text here --></div>
			...
			<div class="container-inner">
				...
				<div class="pad group">
					...
					<div class="grid one-half">
						...
						<div id="credit">
							<p><?php _e('Powered by','hueman'); ?> <a href="http://wordpress.org" rel="nofollow">WordPress</a>. Tema por <a href="http://alxmedia.se" rel="nofollow">Alx</a>.</p>
						</div><!--/#credit-->
						<?php endif; ?>
